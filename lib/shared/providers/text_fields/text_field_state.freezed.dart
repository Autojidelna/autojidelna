...
mixin _$TextFieldState {
 ...
 String? get value; String? get error; bool get obscureText;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TextFieldState&&(identical(other.value, value) || other.value == value)&&(identical(other.error, error) || other.error == error)&&(identical(other.obscureText, obscureText) || other.obscureText == obscureText));
}
...
@useResult
$Res call({
 String? value, String? error, bool obscureText
});
...
/// Create a copy of TextFieldState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? value = freezed,Object? error = freezed,Object? obscureText = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? value,  String? error,  bool obscureText)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TextFieldState() when $default != null:
return $default(_that.value,_that.error,_that.obscureText);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? value,  String? error,  bool obscureText)  $default,) {final _that = this;
switch (_that) {
case _TextFieldState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? value,  String? error,  bool obscureText)?  $default,) {final _that = this;
switch (_that) {
case _TextFieldState() when $default != null:
return $default(_that.value,_that.error,_that.obscureText);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TextFieldState&&(identical(other.value, value) || other.value == value)&&(identical(other.error, error) || other.error == error)&&(identical(other.obscureText, obscureText) || other.obscureText == obscureText));
}
...
/// Create a copy of TextFieldState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? value = freezed,Object? error = freezed,Object? obscureText = null,}) {
