...
class DishDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    SlozeniJidla courses = dish.slozeniJidla!;
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          if (courses.hlavniChod != null && courses.hlavniChod!.trim().isNotEmpty) categoryDetail(l10n.mainCourse, content: courses.hlavniChod!),
      ...
      bottomNavigationBar: BottomAppBar(padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12), child: OrderDishButton(dish)),
    );
  }

  Column categoryDetail(String title, {String? content, Set<Alergen> allergens = const <Alergen>{}}) {
    return Column(
